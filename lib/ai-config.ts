...
export const AI_PROVIDER_OPTIONS: {
...
}[] = [
  {
    value: "disabled",
    label: "Disabled",
    labelKey: "provider_disabled_label",
    desc: "Do not generate AI privacy-policy summaries",
    descKey: "provider_disabled_desc",
  },
  {
    value: "openai",
    label: "OpenAI",
    desc: "Use OpenAI hosted models",
    descKey: "provider_openai_desc",
  },
  {
    value: "anthropic",
    label: "Anthropic",
    desc: "Use Claude models through Anthropic",
    descKey: "provider_anthropic_desc",
  },
  {
    value: "custom",
    label: "Own Model",
    labelKey: "provider_custom_label",
    desc: "Use Ollama or any OpenAI-compatible endpoint",
    descKey: "provider_custom_desc",
  },
];
...
export const OPENAI_MODEL_OPTIONS = [
  {
    value: "gpt-4.1-mini",
    label: "GPT-4.1 Mini",
    desc: "Fast and cost-efficient",
    descKey: "openai_gpt_4_1_mini_desc",
  },
  {
    value: "gpt-4.1",
    label: "GPT-4.1",
    desc: "Stronger reasoning and extraction",
    descKey: "openai_gpt_4_1_desc",
  },
  {
    value: "gpt-4o-mini",
    label: "GPT-4o Mini",
    desc: "Low-cost general model",
    descKey: "openai_gpt_4o_mini_desc",
  },
  {
    value: "gpt-4o",
    label: "GPT-4o",
    desc: "High-quality multimodal model",
    descKey: "openai_gpt_4o_desc",
  },
] as const;
...
export const ANTHROPIC_MODEL_OPTIONS = [
  {
    ...
    descKey: "anthropic_haiku_desc",
  },
  {
    value: "claude-3-7-sonnet-latest",
    label: "Claude 3.7 Sonnet",
    desc: "Balanced quality and speed",
    descKey: "anthropic_sonnet_3_7_desc",
  },
  {
    value: "claude-sonnet-4-20250514",
    label: "Claude Sonnet 4",
    desc: "High-quality extraction",
    descKey: "anthropic_sonnet_4_desc",
  },
  {
    value: "claude-opus-4-20250514",
    label: "Claude Opus 4",
    desc: "Strongest Anthropic model",
    descKey: "anthropic_opus_4_desc",
  },
] as const;
...
export const CUSTOM_MODEL_OPTIONS = [
  {
    value: "llama3.2",
    label: "llama3.2",
    desc: "Good small local default",
    descKey: "custom_llama_3_2_desc",
  },
  {
    value: "qwen2.5:7b",
    label: "qwen2.5:7b",
    desc: "Strong local text model",
    descKey: "custom_qwen_2_5_desc",
  },
  {
    value: "mistral",
    label: "mistral",
    desc: "Lightweight local model",
    descKey: "custom_mistral_desc",
  },
  {
    value: "phi4-mini",
    label: "phi4-mini",
    desc: "Compact local reasoning model",
    descKey: "custom_phi4_desc",
  },
  {
    value: "gpt-oss:20b",
    label: "gpt-oss:20b",
    desc: "Open-weight option if exposed locally",
    descKey: "custom_gpt_oss_desc",
  },
] as const;
...
export function providerUsesChatCompletions(
  provider: Exclude<AIProvider, "disabled">
): boolean {
  return provider === "openai" || provider === "custom";
}

export function providerLikelyNeedsChunking(
  provider: Exclude<AIProvider, "disabled">,
  model: string
): boolean {
  if (provider === "custom") {
...
export function resolveAiTimeoutMs(
  ...
  const clamped = Math.min(
    AI_TIMEOUT_MAX_MS,
    Math.max(AI_TIMEOUT_MIN_MS, Math.floor(parsed))
  );
  return clamped;
}
