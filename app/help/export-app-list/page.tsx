...
export default async function ExportAppListHelpPage() {
  if (resolveFlagFromDb('flag.help.export_guide') !== 'on') notFound();
  const t = await getTranslations('help_export');
  return (
    <div className="help-shell">
      <div className="help-card">
        <div className="help-hero">
          ...
          <Link href="/onboard" className="btn btn-secondary">
        ...
        <div className="help-grid">
          ...
          <section className="help-section help-section-wide">
            ...
            <p className="help-section-copy">
              {t('helper_section_copy')}
            </p>
            <pre className="help-code">
              <code>python3 tools/ios-app-import/export_ios_apps.py --mode backup</code>
            </pre>
          </section>
          ...
          <section className="help-section help-section-wide">
            ...
            <p className="help-section-copy">
              {t('device_section_copy')}
            </p>
            <pre className="help-code">
              <code>python3 tools/ios-app-import/export_ios_apps.py --mode device</code>
            </pre>
          </section>
