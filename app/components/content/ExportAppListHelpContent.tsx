...
export default function ExportAppListHelpContent() {
  const t = useTranslations("help_export");
  return (
    <RequireFlagGate flag="flag.help.export_guide">
