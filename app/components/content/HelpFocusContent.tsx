...
import PurposeCardScene from "@/app/components/PurposeCardScene";
...
export default function HelpFocusContent() {
  ...
  const t = useTranslations("help_focus_page");
  const tSec = useTranslations("help_focus_page.sections");
  // Reuse the /welcome purpose animations to illustrate the goals section.
  const tPurpose = useTranslations("focus_purpose");
  const tAnim = useTranslations("focus_purpose.animation");
