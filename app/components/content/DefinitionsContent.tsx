...
import PrivacyTypeIcon from "@/app/components/PrivacyTypeIcon";
...
export default function DefinitionsContent() {
  ...
  const tSec = useTranslations("help_definitions_page.sections");
  const tBody = useTranslations("help_definitions_page.severity_bodies");
