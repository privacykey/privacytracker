...
export function CardThumbnail({ id }: ThumbProps) {
  switch (id) {
    case "task_list":
      ...
      return (
        <Frame>
          {[14, 26, 38].map((y) => (
            <g key={y}>
              <rect height="8" rx="2" width="8" x="8" y={y - 4} />
              <line x1="20" x2="62" y1={y} y2={y} />
            </g>
          ))}
        </Frame>
      );
    case "review_cta":
      ...
      return (
        <Frame>
          ...
          <line x1="22" x2="50" y1="25" y2="25" />
          <line opacity="0.55" x1="22" x2="44" y1="32" y2="32" />
    ...
    case "focus_strip":
      ...
      return (
        <Frame>
          <rect height="12" opacity="0.4" rx="6" width="64" x="8" y="22" />
          <rect height="6" rx="3" width="14" x="12" y="25" />
          <rect height="6" rx="3" width="20" x="30" y="25" />
          <rect height="6" rx="3" width="14" x="54" y="25" />
        </Frame>
      );
    case "background_mode_wizard":
      ...
      return (
        <Frame>
          <rect height="28" opacity="0.5" rx="4" width="60" x="10" y="14" />
          <path d="M30 22 L42 28 L30 34 Z" fill="currentColor" stroke="none" />
          <line x1="48" x2="62" y1="24" y2="24" />
          <line x1="48" x2="58" y1="30" y2="30" />
        </Frame>
      );
    case "manual_apps_banner":
      ...
      return (
        <Frame>
          ...
          <line x1="18" x2="18" y1="24" y2="32" />
          <line x1="14" x2="22" y1="28" y2="28" />
          <line x1="32" x2="68" y1="22" y2="22" />
          <line x1="32" x2="56" y1="30" y2="30" />
          <line x1="32" x2="50" y1="38" y2="38" />
        </Frame>
      );
    case "risk_section":
      ...
      return (
        <Frame>
          <line opacity="0.6" x1="8" x2="42" y1="14" y2="14" />
          {[24, 36].map((y) => (
            <g key={y}>
              <rect
                height="8"
                ...
                y={y - 4}
              />
              <circle cx="13" cy={y} fill="currentColor" r="2" stroke="none" />
              <line x1="18" x2="48" y1={y} y2={y} />
            </g>
          ))}
        </Frame>
      );
      ...
      return (
        <Frame>
          <rect
            ...
            y="14"
          />
          <line x1="10" x2="64" y1="30" y2="30" />
          <line x1="10" x2="44" y1="38" y2="38" />
        </Frame>
      );
    case "cleanup_callout":
      ...
      return (
        <Frame>
          <rect height="28" opacity="0.5" rx="5" width="68" x="6" y="14" />
          <circle cx="16" cy="28" r="5" />
          <line x1="16" x2="16" y1="25" y2="29" />
          <circle cx="16" cy="31.5" fill="currentColor" r="0.8" stroke="none" />
          <line x1="26" x2="66" y1="24" y2="24" />
          <line x1="26" x2="54" y1="32" y2="32" />
        </Frame>
      );
    case "family_callout":
      ...
      return (
        <Frame>
          ...
          <line x1="44" x2="68" y1="22" y2="22" />
          <line x1="44" x2="62" y1="30" y2="30" />
    ...
    case "third_party_callout":
      ...
      return (
        <Frame>
          ...
          <line x1="16" x2="40" y1="20" y2="36" />
          <line x1="40" x2="64" y1="36" y2="20" />
          <line opacity="0.4" x1="16" x2="64" y1="20" y2="20" />
        </Frame>
      );
    case "glance_section":
    ...
    case "definitions_callout":
      ...
      return (
        <Frame>
          <rect height="28" opacity="0.55" rx="2" width="20" x="8" y="14" />
          <line opacity="0.5" x1="18" x2="18" y1="14" y2="42" />
          <line x1="34" x2="68" y1="20" y2="20" />
          <line x1="34" x2="62" y1="28" y2="28" />
          <line x1="34" x2="58" y1="36" y2="36" />
        </Frame>
      );
    case "review_section":
      ...
      return (
        <Frame>
          {[14, 26, 38].map((y) => (
            <g key={y}>
              <circle cx="12" cy={y} fill="currentColor" r="3" stroke="none" />
              <line x1="20" x2="60" y1={y - 2} y2={y - 2} />
              <line opacity="0.55" x1="20" x2="42" y1={y + 3} y2={y + 3} />
            </g>
          ))}
        </Frame>
      );
      ...
      return (
        <Frame>
          {[
            ...
            <g key={y}>
              <rect height="6" opacity="0.35" rx="3" width="64" x="8" y={y} />
              <rect
                fill="currentColor"
                height="6"
                opacity="0.65"
    ...
    case "stale_section":
      ...
      return (
        <Frame>
          ...
          <line x1="16" x2="16" y1="22" y2="28" />
          <line x1="16" x2="21" y1="28" y2="30" />
          <line x1="32" x2="66" y1="22" y2="22" />
          <line x1="32" x2="60" y1="30" y2="30" />
          <line x1="32" x2="54" y1="38" y2="38" />
        </Frame>
      );
    case "activity_section":
      ...
      return (
        <Frame>
          <line opacity="0.4" x1="14" x2="14" y1="10" y2="46" />
          {[16, 28, 40].map((y) => (
            <g key={y}>
              <circle
                cx="14"
    ...
    default:
      ...
      return (
        <Frame>
          <line x1="10" x2="64" y1="20" y2="20" />
          <line x1="10" x2="58" y1="30" y2="30" />
          <line x1="10" x2="48" y1="40" y2="40" />
        </Frame>
      );
  }
}
