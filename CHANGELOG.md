...
- Rust core Phase 2: nine operational GET routes (63 read routes total), covering job status, backup listings, cooldowns, AI logs, CSP reports, install exports and manual-app detail. Node-derived cases and live probes preserve status, serialization, filesystem errors and read limits without starting jobs. Rust remains inactive in shipped builds. Developer-facing only.
